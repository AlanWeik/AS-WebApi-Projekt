...
{
    public class AS_WebApi_ProjektContextModel : IdentityDbContext<User>
    {
        public AS_WebApi_ProjektContextModel (DbContextOptions<AS_WebApi_ProjektContextModel> options)
            : base(options)
        {
        }
